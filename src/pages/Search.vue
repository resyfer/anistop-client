...
const searchParam = ref(route.query.anime);
...
<template>
  <div class="anime-search">
    <InputText placeholder="Search Anime" v-model="(searchParam as string)" />
    <Button
      text="Search"
      @click="router.push({ path: '/find', query: { anime: searchParam } })" />
  </div>
